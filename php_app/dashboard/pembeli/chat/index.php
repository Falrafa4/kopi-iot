...
if (isset($_GET['id'])) {
    ...
    // Jika tidak ada id_penjual, arahkan kembali ke halaman sebelumnya atau tampilkan pesan error
    header("Location: /");
    exit();
}
?>
...
<head>
    ...
    <title>KOPI IoT - Chat ke Penjual</title>
...
<body>
    ...
    <main>
        <div class="header">
            <a href="/detail.php?id=<?= htmlspecialchars($id_penjual) ?>" class="btn-primary back">
            ...
            <h2>Chat Kepada Penjual</h2>
        </div>

        <div class="container-chat" id="containerChat">
            <div id="box"></div>
            <input type="hidden" id="pengirim" value="2"> <!-- 2 = pembeli -->
            <input type="hidden" id="penerima" value="<?= $id_penjual ?>"> <!-- 1 = penjual -->
