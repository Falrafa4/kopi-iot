...
- PHP versi >= 8.2
- MySQL
- Rangkaian IoT (terpisah)

### Langkah-langkah Instalasi ⏬
1. Clone repository
```bash
git clone https://github.com/Falrafa4/kopi-iot.git
cd kopi-iot/php_app/
```
